...
export function DataTable<TData, TValue>({
    ...
    const activePagination = manualPagination && paginationState
        ? paginationState
        : internalPagination

    const handlePaginationChange: OnChangeFn<PaginationState> = (updater) => {
        console.log('DataTable handlePaginationChange:', { updater, manualPagination, hasOnPaginationChange: !!onPaginationChange })
